...
var DropDownList = (function($,undefined) {
    ...
    DDLClass.prototype = {
        ...
        _createFromSelect : function() {
            ...
            input.parent().click(function(event){
                if(input.parent().hasClass('isDiabled')){
                    return;
                }
        ...
        update : function(option){
            this.configs = $.extend(this.configs, option || {});
            this._init(this.configs);
        }
    };
    ...
    var _create = function(configs) {
        if (configs.container.length < 0 || configs.container.length == 0){
            return;
        }else {
