 ...
 */
define(['app', 'controllers/controllers', 'jquery','/modules/config/configFile.js','layer', '/lib/other/socket.io.js', '/modules/config/common.js', 'select2', 'yituFace'],
    function(app, controllers, $,configFile,layer, io, common, select2, yituFace) {
