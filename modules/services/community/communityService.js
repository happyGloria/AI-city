...
define(['../services'],
    function (services) {
        services.factory('communityService', ['$q','$http',
            function ($q,$http) {
                ...
                var buildingInfo = function(req){
                    return $http.post('/zhsq/village/getHouseByBuilding',req).
                        then(function (response, error) {
                            if (error) {
                                return $q.reject(error);
                            } else {
                ...
                var residengtInfo = function(req){
                    return $http.post('/zhsq/village/getPeopleWaterElecGasVehicleByHouse',req).
                        then(function (response, error) {
                            if (error) {
                                return $q.reject(error);
                            } else {
